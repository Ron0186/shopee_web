...
export const useHelpStore = defineStore("help", () => {
    ...
    const faqCategories = ref([
        ...
        {
            id: 2,
            title: "商品資訊與庫存", // 新增分類標題
            items: [
                {
                    id: "q2-1", // 新增項目 ID
                    question: "如何查詢商品的詳細規格？",
                    answer: "請前往您感興趣的商品頁面，通常在頁面下方會有「商品規格」或「詳細資訊」的標籤頁或區塊，您可以在那裡找到尺寸、材質、重量、功能等詳細規格說明。如果找不到或需要更具體的資訊，歡迎隨時聯繫我們的客服。"
                },
                {
                    id: "q2-2",
                    question: "商品顯示「暫無庫存」何時會補貨？",
                    answer: "商品的補貨時間會依供應商、生產週期等因素而異，暫無確切的統一時間表。建議您可以點擊商品頁面上的「貨到通知我」按鈕（如果有的話），或將商品加入願望清單，並定期回來查看。您也可以聯繫客服詢問特定商品的預計補貨狀況。"
                },
                {
                    id: "q2-3",
                    question: "我可以預購即將上市的商品嗎？",
                    answer: "部分即將上市的熱門商品可能會提供預購選項。請留意我們的「新品預購」專區或在商品頁面上查看是否有「預購」按鈕及相關說明。預購通常需要預先支付部分或全額款項，並會註明預計發貨日期。"
                },
                {
                    id: "q2-4",
                    question: "如何查看其他顧客對商品的評價？",
                    answer: "在大多數商品頁面下方，您會找到「顧客評價」或「用戶回饋」的區塊。您可以在這裡瀏覽其他已購買顧客的星級評分、文字評論以及可能的實拍照片，作為您購物決策的參考。"
                },
                {
                    id: "q2-5",
                    question: "如果我想要的顏色或尺寸顯示缺貨怎麼辦？",
                    answer: "如果特定顏色或尺寸缺貨，您可以先查看是否有其他類似款式或替代選項。若無替代品，建議使用「貨到通知我」功能（若提供），或聯繫客服確認是否有補貨計畫，或是能為您推薦其他相似商品。"
                }
            ]
        },
        {
