<template>
  <div class="container">
    ...
    <div v-else-if="coupons.length === 0">
      目前沒有 {{ statusLabel[currentStatus] }} 的優惠券。
    </div>
        ...
        <div class="card-right">
          <div class="card-header">
            ...
            <div class="right-info">
              ...
              <p :class="['status-badge', statusClass(coupon.status)]">
...
async function fetchCoupons() {
  ...
  try {
    const res = await axios.get(
      `http://localhost:8081/api/user-coupons/with-banner/${userId}`,
      {
