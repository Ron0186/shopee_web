<template>
    ...
    <div v-else>
        <p style="font-size: 23px;line-height: 1.5;font-weight: 700;">
            ...
            歡迎來到幫助中心——解決您的問題，讓使用更輕鬆！
        </p>
        <p>感謝您來到我們的幫助中心！這裡是您獲取支援、尋找解決方案和學習如何更有效使用我們產品與服務的最佳場所。無論您是新用戶，還是已經熟悉我們平台的資深使用者，幫助中心都能為您提供有價值的資訊，協助您快速解決各種問題，讓您的使用體驗更加順暢，如果有和賣家相關問題，請由此路徑進入
            <RouterLink to="/store/22">賣家聊天</RouterLink>。
        </p>
...
export default {
    setup() {
        ...
        const selectedArticle = computed(() =>
            store.faqCategories.flatMap(category => category.items)
