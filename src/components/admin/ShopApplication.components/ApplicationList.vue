<template>
  <div class="container mt-5">
    ...
    <div class="table-container">
      <table class="table table-bordered table-hover table-striped" v-if="showPending">
      ...
      <table class="table table-bordered table-hover table-striped" v-if="showRejected">
...
/* 設定表格容器的固定大小 */
.table-container {
  width: 1200px;  /* 或您希望的寬度 */
  height: 600px; /* 或您希望的高度 */
  overflow: auto; /* 當內容超出時顯示捲軸 */
  margin: 0 auto; /* 讓容器水平置中 */
  border: 1px solid #dee2e6; /* 可選：加上邊框 */
  border-radius: 0.25rem; /* 可選：加上圓角 */
}
