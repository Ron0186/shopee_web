    ...
    <div class="nav-icons">
      ...
      <div v-if="userStore.username" class="user-dropdown">
        ...
        <div class="user-dropdown-content" v-if="userMenuOpen">
          <router-link to="/memberCenter" @click="userMenuOpen = false" class="dropdown-item">
          ...
          <router-link v-if="userStore.username" 
            ...
            class="dropdown-item position-relative" @click="userMenuOpen = false">
          ...
          <div v-if="userStore.isSeller" class="dropdown-group">
            ...
            <router-link :to="'/store/' + userStore.shopId" 
              class="dropdown-item" @click="userMenuOpen = false">
              <span class="dropdown-icon-left">🏪</span>
              <span>賣家中心</span>
            </router-link>
            <router-link to="/seller-setting" 
              class="dropdown-item" @click="userMenuOpen = false">
            ...
            <router-link to="/seller/coupon/apply" 
              class="dropdown-item" @click="userMenuOpen = false">
              <span class="dropdown-icon-left">🎟️</span>
              <span>優惠券申請</span>
            </router-link>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="sidebar-item dropdown">
        <button @click="toggleCategory" class="sidebar-link dropdown-toggle">
          <span class="sidebar-icon">🛍</span>
          <span>商城分類</span>
          <span class="dropdown-arrow" :class="{ 'rotate': categoryOpen }">▼</span>
        </button>
        <ul v-if="categoryOpen" class="dropdown-menu">
          <li class="dropdown-item">
            <router-link to="/shop?category=clothing" @click="toggleDrawer" class="category-link">
              <span class="category-icon">👕</span>
              <span>衣服</span>
            </router-link>
          </li>
          <li class="dropdown-item">
            <router-link to="/shop?category=electronics" @click="toggleDrawer" class="category-link">
              <span class="category-icon">📱</span>
              <span>電子產品</span>
            </router-link>
          </li>
          <li class="dropdown-item">
            <router-link to="/shop?category=home" @click="toggleDrawer" class="category-link">
              <span class="category-icon">🏠</span>
              <span>家用品</span>
            </router-link>
          </li>
          <li class="dropdown-item">
            <router-link to="/shop?category=others" @click="toggleDrawer" class="category-link">
              <span class="category-icon">🔹</span>
              <span>其他</span>
            </router-link>
          </li>
      ...
      <li class="sidebar-item">
        <router-link to="/notifications" @click="toggleDrawer" class="sidebar-link">
          <span class="sidebar-icon">🔔</span>
          <span>通知</span>
        </router-link>
      </li>
      ...
      <li class="sidebar-item">
        <router-link to="/helpCenter" @click="toggleDrawer" class="sidebar-link">
          <span class="sidebar-icon">📞</span>
          <span>客服 & 幫助中心</span>
        </router-link>
      </li>
      ...
      <li class="sidebar-item">
        <router-link to="/payment-methods" @click="toggleDrawer" class="sidebar-link">
          <span class="sidebar-icon">💳</span>
          <span>付款方式</span>
        </router-link>
      </li>
      ...
      <li class="sidebar-item">
        <router-link :to="{ name: 'ShopListPage' }" @click="toggleDrawer" class="sidebar-link shop-list-link">
          <span class="sidebar-icon">🏬</span>
          <span>查看商店列表</span>
        </router-link>
      </li>
...
@media (max-width: 768px) {
  ...
  .nav-text, .admin-text, .username-text {
    display: none;
  }
